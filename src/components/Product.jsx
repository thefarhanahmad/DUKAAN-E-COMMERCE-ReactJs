...
const Product = ({ item }) => {
  ...
  return (
    <div className="bg-white hover:shadow-2xl  rounded-md hover:scale-105 transition-all duration-300 shadow-lg lg:w-[30%] h-[50%] md:w-[40%] sm:w-[80%] overflow-hidden box-border">
